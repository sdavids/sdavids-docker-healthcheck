...
[,console]
----
$ docker run --platform=linux/amd64 --rm debian:12.12-slim sh -c "apt-get -qq update && apt-get -qq install -y curl=7.88.1-10+deb12u14 >/dev/null 2>&1 && ldd /usr/bin/curl | awk '{ print $ 3}' | xargs du -ckshL /usr/bin/curl"
276K    /usr/bin/curl
